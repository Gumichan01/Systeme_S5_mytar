...
typedef struct Parametres{
	...
	int flag_l;	/* flag liste des fichiers qui sont dans l'archive  (TODO Luxon)*/
	...
	int flag_C;	/* flag mettre le répertoire mis en paramètre avec -C comme racine (TODO ensemble) */
	int flag_v;	/* flag verification intégrité de l'archive (TODO ensemble) */
